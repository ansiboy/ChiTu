declare namespace chitu {
    type LoadJS = (path: string) => Promise<{
        default: (page: Page, app: PageMaster) => void | {
            new (page: Page, app: PageMaster): any;
        };
    }>;
    class PageMaster {
        ...
        protected static defaultPageNodeParser(): PageNodeParser;
        static createDefaultAction(url: string, loadjs: LoadJS): Action;
...
declare namespace chitu {
    ...
    class Application extends PageMaster {
        ...
        redirect<T extends {
            [k in keyof T]: string;
        }>(pageName: string, args?: T): Page;
        redirect<T extends {
            [k in keyof T]: string;
        }>(pageName: string, fromCache?: boolean, args?: T): Page;
        back(): void;
